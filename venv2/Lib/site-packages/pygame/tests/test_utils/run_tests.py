...
if is_pygame_pkg:
    ...
    from Pizza_Panic.test_utils import import_submodule
    from Pizza_Panic.test_utils.test_runner \
         import prepare_test_env, run_test, combine_results, \
                get_test_results, TEST_RESULTS_START
import pygame
...
def run(*args, **kwds):
    ...
    #
        ...
        if is_pygame_pkg:
            ...
            from Pizza_Panic.test_utils.async_sub import proc_in_time_or_kill
